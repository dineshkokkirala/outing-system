...
class AddStudent extends Component {
    ...
    onSubmitHandler= async(e)=>{
        ...
        const user={firstname,lastname,department,gender,section,year,outingtype,email,mobile,regno:regno.toLowerCase(),parent,parentmobile,address,bloodgroup,hostelname}
        console.log(user)
                    ...
                    <div className="row">
                        <h1 className="col-12 text-center mt-2 mb-2">Add Student</h1>
                           ...
                           {error&&(<p className="text-danger text-center mt-3 mb-3">*{errorMessage}</p>)}
                            ...
                            <button className="btn btn-dark btn-block" onClick={this.onSubmitHandler}>Add Student</button>
